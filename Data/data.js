...
Rich in calcium`,
    ...
    {
        id:13,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=540/app/assets/products/sliding_images/jpeg/8b000aad-94c7-401e-b8b6-3f5d7b0a9cc0.jpg?ts=1707806509",
        name:`Maggi Special Masala Spicy Instant Noodles - Pack of 12`,
        weight:"12x70 g",
        price:192,
        dis_price:210,
        category:"Breakfast & instant food",
        Key_Features:`Your favourite MAGGI now with an all new Special Masala
An invigorating recipe of 20 spices and herbs with the goodness of iron
Contains a blend of finely grounded and whole spices, roasted to perfection
Each portion helps meet 15% of your daily iron requirement`,
    ...
    {
        id:14,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=1080/app/assets/products/sliding_images/jpeg/059e8a66-ab68-4e21-a150-3d2c30607ff2.jpg?ts=1723377105",
        name:`Chef's Basket Instant Macaroni Pasta`,
        weight:"850 g",
        price:100,
        dis_price:120,
        category:"Breakfast & instant food",
        Key_Features:`This Pasta has been crafted from the finest quality ingredients.
It satisfies your cravings for authentic Italian Pasta.
Its perfect shape and size allow any sauce or dressing to seep well.
Perfect any time snack, cook with rich olive oil and lots of fresh vegetables.
Perfect with pesto and tomato-based sauces.`,
        Type:"Macaroni",
        Country_of_Origin:"India",
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
    ...
    {
        id:15,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=900/app/assets/products/sliding_images/jpeg/8937ab2e-eda9-43e2-a261-d550230eb8b2.jpg?ts=1723375142",
        name:`Knorr Hot & Sour Vegetable Soup`,
        weight:"41 g",
        price:60,
        dis_price:89,
        category:"Breakfast & instant food",
        Key_Features:`Made with 100% real vegetables.
...
Ready to eat in 3 simple steps.`,
    ...
    {
        id:16,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=1080/app/assets/products/sliding_images/jpeg/b56488f8-430e-4a82-9aa2-03d4bde655a5.jpg?ts=1723098534",
        name:`Yoga Bar Chocolate Chunk Nut Multigrain Protein Bar (38 g)`,
        weight:"38 g",
        price:38,
        dis_price:49,
        category:"Breakfast & instant food",
        Key_Features:`Chocolate energy`,
        Type:"Macaroni",
        Country_of_Origin:"India",
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
        Description:`Loaded with the goodness of whole grains, dried fruits, nuts, seeds, and cocoa
...
Rich in Fibre`,
    ...
    {
        id:17,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=900/app/assets/products/sliding_images/jpeg/cb0b6908-856f-4a66-b3c5-1ee495445f91.jpg?ts=1713170916",
        name:`Nestle KitKat Minis Chocolate Coated Wafer Bar`,
        weight:"123.2 g",
        price:112,
        dis_price:120,
        category:"Sweet Tooth",
        Key_Features:`Delight your taste buds with your favourite KITKAT wafer bar in a mini-size.
Indulge in the delicious crispy & chocolaty wafer bar and make your mini breaks delightful.
This pack is perfect for enjoying at home or for passing around with your friends and family.
Carry a KITKAT Mini in your pocket, bag or lunchbox and enjoy it anytime, anywhere.
Pack contains 18 units of 1 Finger breaks inside.`,
        Type:"Chocolates ",
        Country_of_Origin:"India",
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
...
Share your favourite treats with your favourite people and indulge in the deliciousness of NESTLE KITKAT Minis! This share bag contains 18 units of KITKAT Minis, making it perfect for stocking up or passing around with friends and family. The iconic taste and texture of KitKat , combined with the crispiness of the wafer bar, will delight your senses and make your breaks delicious! Outer Packing may vary depending on stock availability`,
    ...
    {
        id:18,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=85,metadata=none,w=480,h=480/app/assets/products/large_images/jpeg/b5528701-6cc1-4094-9c9a-ce8c5c147852.jpg?ts=1722517782",
        name:`Cadbury Celebrations Rich Dry Fruit Collection Chocolate Gift Pack`,
        weight:"177 g",
        price:440,
        dis_price:499,
        category:"Sweet Tooth",
        Key_Features:`-A perfect gift for Rakhi to show love & admiration to your loved ones
-This gift pack contains Almonds, Cashews & Raisins enrobed in rich chocolate
-Celebrate this Rakhi by gifting Cadbury Celebrations to your friends and family.`,
        Type:"Chocolates ",
        Country_of_Origin:"India",
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
    ...
    {
        id:19,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=85,metadata=none,w=480,h=480/app/images/products/full_screen/pro_479704.jpg?ts=1685984544",
        name:`NVeeba Chef's Special Tomato Ketchup`,
        weight:"900 g",
        price:75,
        dis_price:99,
        category:"Sauces & spreads",
        Key_Features:`Made from rich, high quality tomatoes.
...
Tangy taste that goes well with every snack.`,
        ...
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
        Description:`Made from rich, high quality tomatoes.
A perfect dip for snacks and sandwiches.
Tangy taste that goes well with every snack.`,
    ...
    {
        id:20,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=85,metadata=none,w=480,h=480/app/assets/products/large_images/jpeg/0efd1a16-11f6-4d48-8fda-a99d99b82e86.jpg?ts=1707312307",
        name:`Fortune Soya Health Refined Soyabean Oil`,
        weight:"1 L",
        price:114,
        dis_price:120,
        category:"Masala,oil & More",
        Key_Features:`India’s No.1 Oil - Healthy Refined oil for your Family,
...
Adds extra Flavour to your favourite food.`,
        ...
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
        Description:`Fortune soya health is certified as India's No. 1 cooking oil brand. It is fortified with Vitamin A & Vitamin D which helps bosting immunity.
...
Your everyday meals prepared with Fortune soya health oil not only tastes better, but also make your bones stronger and heart healthier.`,
    ...
    {
        id:21,
        img:"https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=85,metadata=none,w=480,h=480/app/assets/products/large_images/jpeg/147192a4-9eb8-42e1-81b4-3494d578465f.jpg?ts=1722662746",
        name:`Brooke Bond Taj Mahal Tea 250 g`,
        weight:"250 g",
        price:170,
        dis_price:199,
        category:"Tea,Coffee & Health Drink",
        Key_Features:`Tasted, graded and perfectly blended at the Brooke bond Tea Excellence Centre
Comes in a unique flavour lock pack
Invites you to cheer your senses
Perfect balance of strength and flavour`,
        Type:"Leaf Tea ",
        Country_of_Origin:"India",
        Return_Policy:`This Item is non-returnable. For a damaged, defective, incorrect or expired item, you can request a replacement within 72 hours of delivery.
        In case of an incorrect item, you may raise a replacement or return request only if the item is sealed/ unopened/ unused and in original condition.`,
