  ...
  return (
    <div className=' account w-[250px]  bg-white rounded-2xl absolute  mx-5 my-2 border-[1px] border-zinc-300 flex justify-between flex-col  z-20'>
       ...
       {!trues? <div className=' flex flex-col'>
        ...
        {!trues?<h2 className=' logout py-2  px-4 border-t-[1px] border-zinc-300 font-bold cursor-pointer hover:bg-zinc-200  text-zinc-700 hover:px-6 transition-all ease-in-out ' onClick={Show}><i class="ri-logout-box-r-line mr-2"></i>Login</h2>:""}
        {showLogIn?
